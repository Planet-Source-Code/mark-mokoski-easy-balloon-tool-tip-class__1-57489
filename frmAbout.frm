...
Begin VB.Form frmAbout 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   945
      Left            =   5640
      MouseIcon       =   "frmAbout.frx":1AFC
      MousePointer    =   99  'Custom
      Picture         =   "frmAbout.frx":1E06
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   3360
      Width           =   1260
...
Private Sub emailLabel_Click()
    ...
    ShellExecute hWnd, vbNullString, "mailto:markm@cmtelephone.com?Subject=Questions or Comments on WA1ZEK's DX Cluster Telnet Client Software.", vbNullString, vbNullString, vbNormalFocus
